...
class CalcViewModel: ViewModel() {
    ...
    private fun onDecimalClicked(){
        ...
        if (currentState.operator == null && currentState.num2.isEmpty() && !currentState.num1.contains(".")){
            state.value = currentState.copy(num1 = currentState.num1 + ".")
        }else if(currentState.operator != null && currentState.num2.isNotEmpty() && !currentState.num2.contains(".")){
